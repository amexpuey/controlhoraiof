...
import { AlertTriangle, BookOpen, FileText, HelpCircle, Settings, Smartphone, Users } from "lucide-react";
...
export default function HelpCenter({ isStandalone = false }: HelpCenterProps) {

...
export default function VacationCalendar() {
  ...
  return (
    <div ref={printRef} style={{ maxWidth: 1200, margin: "0 auto" }}>
      {/* Header */}
      <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 20 }}>
        <div>
          <h2 style={{ fontSize: 22, fontWeight: 800, color: "var(--text)", display: "flex", alignItems: "center", gap: 8 }}>
            ...
            Calendario de vacaciones {cal.year}
          </h2>
          <p style={{ fontSize: 14, color: "var(--text-muted)", marginTop: 4 }}>
            Haz clic en las celdas para asignar ausencias. Selecciona el tipo primero.
          </p>
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button onClick={handlePrint} className="btn btn-outline" style={{ padding: "6px 14px", fontSize: 13 }}>
      ...
      <div className="feature-card" style={{ padding: "14px 20px", marginBottom: 20 }}>
